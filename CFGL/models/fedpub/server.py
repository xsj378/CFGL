...
class Server(ServerModule):
    def __init__(self, args, sd, gpu_server):
        ...
        self.sd['proxy'] = self.get_proxy_data(args.n_feat)#生成随机图数据
        self.update_lists = []
        self.sim_matrices = []
    ...
    def get_proxy_data(self, n_feat):
        ...
        data = from_networkx(nx.random_partition_graph([num_nodes] * num_graphs, p_in=0.1, p_out=0, seed=self.args.seed))# 随机图
